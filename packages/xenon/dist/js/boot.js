...
if (WEBPACK) {
    ...
    introText = require('fs').readFileSync(path.join(__dirname, '..', 'manual', 'intro.md'), { encoding: 'utf-8' });
}
...
function load() {
    baseModules = [eventbus = require('./eventbus'), ui = require('./ui'), require("./command"), editor = require("./editor"), require("./title_bar"), require("./symbol"), require("./config"), require("./goto"), require("./tree"), require("./state"), require("./project"), require("./keys"), require("./complete"), session_manager = require("./session_manager"), require("./modes"), require("./split"), require("./file"), require("./preview"), require("./dnd"), require("./handlers"), require("./action"), require("./theme"),
    // require("./log"),
    require("./window_commands"), require("./analytics"), WEBPACK ? console.log('chrome app does not have a menu') : require("./menu"), require("./db"), require("./webservers"), require("./sandboxes"), openUI = require("./open_ui"),
    // require("./background"),
    history = require("./history"), require("./local_store"),
    // require("./sandbox"),
    require("./webserver"), require("./window"), tracker = require("./analytics_tracker"), require("./configfs"), require('./fs'), WEBPACK ? console.log('chrome app does not have xenpm') : require('./xenpm')
    // "./mac_cli_command.nw",
    // "./cli.nw"
    ];
